            ...
            <form onSubmit={handleLogin}>
              ...
              <div className="flex items-center border border-green-200 dark:border-green-600 rounded-lg px-3 py-2 mb-4 bg-green-50 dark:bg-gray-700 focus-within:ring-2 focus-within:ring-green-400 transition">
                ...
                <input
                  ...
                  className="flex-grow bg-transparent outline-none text-green-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-400 disabled:opacity-50"
                  value={email}
              ...
              <motion.button
                ...
                disabled={isLoading}
                className={clsx(
                  "w-full bg-gradient-to-r from-green-600 via-green-700 to-green-800 dark:from-green-700 dark:via-green-800 dark:to-green-900 text-white py-2 rounded-lg transition font-semibold shadow-lg flex items-center justify-center gap-2 text-lg",
                  isLoading ? "opacity-70 cursor-not-allowed" : "hover:bg-green-800 dark:hover:bg-green-700 cursor-pointer"
                )}
                type="submit"
              >
                {isLoading ? (

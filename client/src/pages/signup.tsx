      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-white to-green-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-gray-900 dark:text-white px-4">
        ...
        >
          ...
          <motion.button
            ...
            className={`w-full bg-gradient-to-r from-green-600 to-green-700 text-white font-semibold py-2 rounded-lg shadow-lg hover:bg-green-800 dark:hover:bg-green-700 transition flex items-center justify-center gap-2 text-lg ${isLoading ? 'opacity-70 cursor-not-allowed' : 'cursor-pointer'}`}
            disabled={isLoading}
            type="submit"
            aria-label="Register"
          >
